    ...
    <>
      ...
      <section className="py-24 lg:py-32 bg-ivory">
        <div className="max-w-(--breakpoint-2xl) mx-auto px-6 lg:px-10">
          ...
          >
            <span className="font-serif-lux text-gold text-sm tracking-luxe-sm uppercase">Journal</span>
            <h1 className="font-display text-4xl lg:text-7xl text-jet mt-3">The YSI Edit</h1>
            <div className="gold-divider mt-6 w-24 mx-auto" />
            <p className="text-jet/60 text-sm max-w-lg mx-auto mt-6 leading-relaxed">
              Discover insightful stories on style, craftsmanship, and the art of dressing well.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      {/* Articles */}
      <section className="pb-24 lg:pb-32 bg-ivory">
        <div className="max-w-(--breakpoint-2xl) mx-auto px-6 lg:px-10">
          <motion.div
              ...
              >
                <Link href={`/journal/${article.slug}`}>
                  ...
                  <div className="mt-5">
                    ...
                    <h2 className="font-poppins text-base lg:text-lg text-jet mt-2 leading-snug group-hover:text-gold transition-colors duration-300">
                      {article.title}
                    </h2>
